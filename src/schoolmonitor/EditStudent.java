    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        if (p == 0) {
            try {
                ...
                String sql = "update ROOT.STUDENTS set BARCODE = '" + Barcode + "', LRN = '" + LRN + "', FIRSTNAME = '" + FN
                        + "', MIDDLENAME = '" + MN + "', LASTNAME = '" + LN + "', ADVISER = '" + Adviser + "', CONTACTNUMBER = '" + PContact
                        + "', GRADELEVEL = '" + GR + "', SECTION = '" + Section + "', SPECIALIZATION = '" + Spec + "', AGE = " + Age
                        + ", PHOTOLINK = '" + Photolink + "', GENDER = '" + Gender + "', HOMEADDRESS = '" + Address + "' WHERE LRN = '" + Bar + "'";
