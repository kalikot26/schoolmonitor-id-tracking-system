...
public class EditInfo extends javax.swing.JFrame {
    ...
    public EditInfo(String Barcode) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Admin/Staff/Visitor Info");
        ...
        if (p == 0) {
            try {
                ...
                String sql = "update ROOT.LOGIN set BARCODE = '" + Barcode + "', PREFIX = '" + Salut + "', FIRSTNAME = '" + FN + "', LASTNAME = '" + LN
                        + "', USERNAME = '" + Uname + "', GENDER = '" + Gender + "', CREDENTIAL = '" + Cred + "', AGE = " + Age + ", PHOTOLINK = '" + Photolink + "' WHERE BARCODE = '" + Bar + "'";
